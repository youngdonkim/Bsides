#!/usr/bin/env python3
"""
zero-to-prototype phase runner.
...
Example: python3 run-phases.py v1-prototype
"""
...
def get_cycle_label() -> str:
    if len(sys.argv) < 2:
        ...
        print("Example: python3 run-phases.py v1-prototype")
        sys.exit(EXIT_ERROR)
    return sys.argv[1]
...
def main():
    ...
    project_name = index.get("project", "zero-to-prototype")
    ...
    # --- Header ---
    print(f"\n{'='*60}")
    print(f"  zero-to-prototype Phase Runner")
